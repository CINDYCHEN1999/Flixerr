package com.codepath.rkpandey.flixerr;
...
import com.codepath.rkpandey.flixerr.models.Movie;
...
public class DetailActivity extends YouTubeBaseActivity {
    ...
    public static final String YOUTUBE_API_KEY = "AIzaSyDW_z0AhNhb6FkBF_Pq1pMY7Bzm2rvBMKU";
        ...
        client.get(String.format(YOUTUBE_URL, movie.getMovieId()), new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int i, Headers headers, JSON json) {
                try {
                    ...
                    Log.e("DetailActivity", "fail json", e);
                }
            }
    ...
    private void initializeYoutube(final String youtubeKey) {
        youTubePlayerView.initialize(YOUTUBE_API_KEY, new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
                Log.d("DetailActivity", "onSucceed");
